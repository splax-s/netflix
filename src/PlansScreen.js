...
function PlansScreen() {
    ...
    const loadCheckout = async (priceId) => {
        ...
        docRef.onSnapshot(async(snap) => {
            ...
            if (sessionId) {
                const stripe = await loadStripe("pk_test_51IPysMBFqTTHRIXrdM9K752erLkQqvfmuz6xQ9OwFuh3mblgUXSFIfezyFDTpcFjsDMJheeMoH8kO4IWz9r8vrJC002B5saKUT")
        ...
        <div className="plansScreen">
            ...
            return (
                   ...
                   plansScreen_plan`}>
                       ...
                       <button className="plansScreen_button" 
                       onClick={() => 
